  ...
  return (
    <section className="w-full py-20 px-6 md:px-[124px] bg-white">
      <div className="container mx-auto">
        <div className="w-full bg-primary relative overflow-hidden flex flex-col lg:flex-row items-center min-h-[414px]  relative">
          {/* Text Content */}
          <div className="p-10 md:p-16 relative z-10 w-full lg:w-1/2 flex flex-col items-start gap-6">
            ...
            <button className="px-8 py-4 bg-white text-primary font-bold text-lg hover:bg-gray-100 transition-all  shadow-xl shadow-black/10">
              Sign Up For Free
            </button>
          </div>
